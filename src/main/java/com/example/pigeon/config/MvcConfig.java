...
import com.example.pigeon.validation.EmailValidator;
import com.example.pigeon.validation.PasswordMatchesValidator;
...
@Configuration
@ComponentScan(basePackages = {"com.example.pigeon.web"})
@EnableWebMvc
